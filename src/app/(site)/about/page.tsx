...
export default function AboutPage() {
  return (
    <div className="bg-white w-full p-0">
      <section className="relative h-[55vh] pt-40 min-h-[450px] w-full overflow-hidden bg-slate-900 text-white">
        ...
        <div className="container relative mx-auto flex h-full max-w-7xl flex-col justify-end px-6 pb-20 pt-32">
          ...
          >
            ...
            <p className="mt-5 max-w-2xl text-base text-slate-300 leading-relaxed">
              Raj & Raj has been the premier name in steel furniture
              manufacturing for over five decades. We blend industrial precision
              with corporate elegance to define modern workspaces.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-7xl px-6">
          <div className="grid grid-cols-2 gap-8 py-10 md:grid-cols-4">
            {[
              ...
              <div
                key={i}
                className="flex flex-col items-center justify-center border-r border-black/5 last:border-0 md:items-start md:pl-8 first:pl-0"
              >
                <span className="text-2xl font-bold text-[color:var(--ink)] sm:text-3xl">
                  {stat.value}
                </span>
                <span className="mt-1 text-xs font-medium uppercase tracking-wider text-[color:var(--muted)]">
                  {stat.label}
                </span>
              </div>
            ))}
      ...
      <section className="py-20">
        <div className="mx-auto max-w-7xl px-6">
          <div className="grid gap-16 lg:grid-cols-2 lg:items-center">
            ...
            >
              <h2 className="text-xs font-bold uppercase tracking-widest text-[color:var(--brand)] mb-2">
                Our Legacy
              </h2>
              ...
              <div className="space-y-4 text-base text-[color:var(--muted)] leading-relaxed">
                <p>
                  Founded by Late Mr. Jagdish Prasad Gupta in 1968, Raj & Raj
                  began with a simple mission: to build furniture that lasts a
                  lifetime. What started as a modest manufacturing unit in
                  Kolkata has transformed into a state-of-the-art facility
                  serving the biggest names in the corporate world.
                </p>
                <p>
                  Today, we don't just manufacture furniture; we engineer
                  productivity. Our rigorous quality control and commitment to
                  ergonomic design have made us the preferred partner for
                  organizations like the Airport Authority of India, SBI, and
                  Aditya Birla Group.
                </p>
              </div>
      ...
      <section className="bg-slate-50 py-20">
        <div className="mx-auto max-w-7xl px-6">
          <div className="mb-12 md:text-center max-w-3xl mx-auto">
            <h2 className="text-2xl font-bold text-[color:var(--ink)] sm:text-3xl">
              Meet the Leadership
            </h2>
      ...
      <section className="py-20">
        <div className="mx-auto max-w-7xl px-6">
          <div className="grid gap-12 lg:grid-cols-2">
            <div className="pr-8">
              <h2 className="text-2xl font-bold text-[color:var(--ink)] sm:text-3xl mb-5">
                Built on Unshakeable Values
              </h2>
              <p className="text-base text-[color:var(--muted)] leading-relaxed mb-6">
                In an industry full of shortcuts, we choose the long road of
                quality and integrity. These core principles guide every piece
                of furniture that leaves our factory floor.
              </p>
              ...
              {[
                {
                  ...
                  desc: "We respect timelines as much as we respect quality.",
                },
                {
                  icon: Trophy,
                  title: "Unmatched Quality",
                  desc: "Rigorous testing ensures durability for decades.",
                },
                {
                  icon: Users,
                ...
                <div
                  key={i}
                  className="rounded-lg border border-black/5 bg-white p-5 shadow-sm hover:border-[color:var(--brand)]/30 transition-colors"
                >
                  <val.icon className="h-6 w-6 text-[color:var(--brand)] mb-3" />
                  <h4 className="font-bold text-[color:var(--ink)] text-sm">
                    {val.title}
                  </h4>
                  <p className="mt-1.5 text-xs text-[color:var(--muted)] leading-relaxed">
                    {val.desc}
                  </p>
                </div>
              ))}
