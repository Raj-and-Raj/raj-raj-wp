      ...
      <section className="py-20">
        <div className="container mx-auto max-w-4xl px-6">
          <div className="space-y-12 text-lg text-slate-600 leading-relaxed">
            ...
            <section>
              <h2 className="text-3xl font-bold text-slate-900 mb-6">Comments</h2>
            ...
            <section>
              <h2 className="text-3xl font-bold text-slate-900 mb-6">Media</h2>
              <p>If you upload images to the website, you should avoid uploading images with embedded location data (EXIF GPS) included. Visitors to the website can download and extract any location data from images on the website.</p>
            </section>

            <section>
              <h2 className="text-3xl font-bold text-slate-900 mb-6">Cookies</h2>
            ...
            <section>
              <h2 className="text-3xl font-bold text-slate-900 mb-6">Embedded content from other websites</h2>
            ...
            <section>
              <h2 className="text-3xl font-bold text-slate-900 mb-6">Who we share your data with</h2>
              <p>If you request a password reset, your IP address will be included in the reset email.</p>
            </section>

            <section>
              <h2 className="text-3xl font-bold text-slate-900 mb-6">How long we retain your data</h2>
            ...
            <section>
              <h2 className="text-3xl font-bold text-slate-900 mb-6">What rights you have over your data</h2>
