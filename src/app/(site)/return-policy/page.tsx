        ...
        <div className="container mx-auto max-w-4xl px-6">
          <div className="space-y-12 text-lg text-slate-600 leading-relaxed">
            <section>
              ...
              <p className="mb-4">Our refund and returns policy lasts 30 days. If 30 days have passed since your purchase, we can’t offer you a full refund or exchange.</p>
              ...
              <p className="mb-4">Several types of goods are exempt from being returned. Perishable goods such as food, flowers, newspapers or magazines cannot be returned. We also do not accept products that are intimate or sanitary goods, hazardous materials, or flammable liquids or gases.</p>
              
              <div className="my-8 rounded-xl bg-slate-50 p-6 border border-slate-100">
                <p className="mb-4 font-bold text-slate-900">Additional non-returnable items:</p>
              ...
              <p className="mb-4 font-medium text-slate-900">Please do not send your purchase back to the manufacturer.</p>

              <div className="my-8 rounded-xl bg-slate-50 p-6 border border-slate-100">
                <p className="mb-4 font-bold text-slate-900">There are certain situations where only partial refunds are granted:</p>
                <ul className="list-disc pl-5 space-y-2">
            ...
            <section>
              <h2 className="text-3xl font-bold text-slate-900 mb-6">Late or missing refunds</h2>
            ...
            <section>
              <h2 className="text-3xl font-bold text-slate-900 mb-6">Sale items</h2>
            ...
            <section>
              <h2 className="text-3xl font-bold text-slate-900 mb-6">Gifts</h2>
            ...
            <section>
              ...
              <p className="mb-4">To return your product, you should mail your product to our physical address.</p>
            ...
            <section className="bg-slate-50 p-8 rounded-2xl border border-slate-100 text-center">
              ...
              <p className="mb-6">Contact us for questions related to refunds and returns.</p>
              <a href="mailto:hello@rajandraj.co" className="inline-flex items-center justify-center px-6 py-3 border border-transparent text-base font-medium rounded-full text-white bg-[color:var(--brand)] hover:opacity-90 transition-opacity">
                Contact Support
              </a>
            </section>
          </div>
