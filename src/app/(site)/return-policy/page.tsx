        ...
        <div className="container relative mx-auto max-w-5xl px-6 text-center">
          ...
          >
            ...
            <p className="text-lg text-slate-500 max-w-2xl mx-auto leading-relaxed">
              ...
              about our return process below.
            </p>
          </motion.div>
        </div>
      </section>
          ...
          <div className="space-y-10 text-base text-slate-600 leading-relaxed">
            ...
            <section>
              ...
              <p>
                ...
                <a
                  href="mailto:hello@rajandraj.co"
            ...
            <section>
              ...
              <p>
                ...
                and send your item to our physical address.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                ...
                we will send a refund to the gift giver and they will find out
                about your return.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="mb-3">
                To return your product, you should mail your product to our
                physical address.
              </p>
              <p className="mb-3">
              ...
              <p>
                If you are returning more expensive items, you may consider
            ...
            <section className="bg-slate-50 p-6 rounded-xl border border-slate-100 text-center">
              ...
              <a
                href="mailto:hello@rajandraj.co"
                className="inline-flex items-center justify-center px-5 py-2.5 border border-transparent text-sm font-medium rounded-full  "
              >
                Contact Support
              </a>
            </section>
