...
export function SiteFooter() {
  ...
  return (
    <footer className="relative overflow-hidden border-t border-slate-200 bg-[radial-gradient(circle_at_top,_rgba(221,51,51,0.08),_transparent_50%),linear-gradient(180deg,#f8fafc,white)] pt-16 pb-10 text-slate-600">
      <div className="absolute -top-24 right-[-120px] h-56 w-56 rounded-full bg-[color:var(--brand)]/10 blur-3xl" />
      <div className="container relative mx-auto px-6">
        <div className="grid grid-cols-1 gap-12 md:grid-cols-2 lg:grid-cols-4">
          <div className="space-y-6">
            ...
            <p className="text-slate-500 text-sm leading-relaxed max-w-xs">
              Crafting premium steel storage solutions for modern homes and
              businesses. Quality, durability, and style in every piece.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-slate-500">
              <li>
                <Link
                  href="/about"
                  className="hover:text-[color:var(--brand)] transition-colors flex items-center gap-2 group"
                >
          ...
          <div>
            ...
            <div className="mb-8 bg-white p-5 rounded-xl border border-slate-200 shadow-sm">
              ...
              <a
                ...
                className="text-xl font-bold text-[color:var(--brand)] hover:opacity-80 transition-opacity block"
              >
                +91 33 4800 0018
              </a>
            </div>
        ...
        <div className="mt-14 border-t border-slate-200 pt-8 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-3">
            <div className="h-7 px-2.5 rounded border border-slate-200 bg-white flex items-center justify-center text-[10px] font-bold text-slate-600 tracking-wide shadow-sm">
              VISA
            </div>
            <div className="h-7 px-2.5 rounded border border-slate-200 bg-white flex items-center justify-center text-[10px] font-bold text-slate-600 tracking-wide shadow-sm">
              MASTERCARD
